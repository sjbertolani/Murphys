...
1. Linguistic belief state
   ...
   - The belief state is not a sufficient statistic in the strict Bayesian sense; the LLM still sees the history. Its practical role is to organize and compress reasoning.
...
5. Multi-trial aggregation
   ...
   - Optional shrinkage pulls toward 0.5 when trial logit variance is high.
